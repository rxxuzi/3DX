...
public class Calculator {
	...
	static double[] getProject(double[] ViewFrom, double[] ViewTo, double x, double y, double z, Plane P){
		...
		double VNP = P.NewVector.x*P.P[0]        + P.NewVector.y*P.P[1] 		 +  P.NewVector.z*P.P[2];
		double VCP = P.NewVector.x*ViewFrom[0]   + P.NewVector.y*ViewFrom[1]   +  P.NewVector.z*ViewFrom[2] ;
		double VTP = P.NewVector.x*ViewToPoint.x + P.NewVector.y*ViewToPoint.y +  P.NewVector.z*ViewToPoint.z;
