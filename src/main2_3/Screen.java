...
//	static ArrayList<Ground> Ground = new ArrayList<Ground>();
	...
	static final long deleteinterval = 350;
...
//		Cube.get(0).updatePoly();
		...
		g.drawString("CONDITION: " + condition , 20 ,195);
	...
	private void KeyControl(){
		...
		if(Control[8]) {
			...
			if(CoordinateCheck(xyz)) {
				Cube.add(new Cube(-rx/20 , ry/20 , rz/20 + 2, 1, 1, 1, new Color(rx , ry , rz) ));
				condition = "CUBE GENERATED : (x,y,z) = " + rx +"," + ry + "," + rz ;
			}
			counter1 ++ ;
		}
	}
