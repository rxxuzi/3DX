...
public class Screen extends JPanel implements KeyListener, MouseListener, MouseMotionListener, MouseWheelListener{
	...
	{		
		...
		Cubes.add(new Cube(20, -2, 0, 2, 5, 5, Color.red));
	}	
	...
	public void paintComponent(Graphics g)
	{
		...
		g.fillRect(0, 0, (int)Main_Engine.ScreenSize.getWidth(), (int)Main_Engine.ScreenSize.getHeight());
		...
		g.drawString("Horizontal View Range (arctan)" + HorLook, 40 ,60);
		g.drawString("Vertical View Range (arctan)" + VertLook, 40 ,80);
...
//		System.out.println(repaintTime);
	...
	void drawMouseAim(Graphics g)
	{
		...
		g.drawLine((int)(Main_Engine.ScreenSize.getWidth()/2 - aimSight), (int)(Main_Engine.ScreenSize.getHeight()/2), (int)(Main_Engine.ScreenSize.getWidth()/2 + aimSight), (int)(Main_Engine.ScreenSize.getHeight()/2));
		g.drawLine((int)(Main_Engine.ScreenSize.getWidth()/2), (int)(Main_Engine.ScreenSize.getHeight()/2 - aimSight), (int)(Main_Engine.ScreenSize.getWidth()/2), (int)(Main_Engine.ScreenSize.getHeight()/2 + aimSight));			
	}
	...
	{		
			double difX = (NewMouseX - Main_Engine.ScreenSize.getWidth()/2);
			double difY = (NewMouseY - Main_Engine.ScreenSize.getHeight()/2);
	...
	void CenterMouse() 
	{
			try {
				r = new Robot();
				r.mouseMove((int)Main_Engine.ScreenSize.getWidth()/2, (int)Main_Engine.ScreenSize.getHeight()/2);
